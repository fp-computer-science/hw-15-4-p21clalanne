...
### Dictionary Methods
---
Answer each of the following questions in a separate Python file named `hw15-4-#.py` where `#` is the number of the question. In your heading, put your name and the date you began working on the file. (5 pts. each)
